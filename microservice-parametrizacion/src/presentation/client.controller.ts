...
export class ClientController {
  ...
  @ApiOperation({
    ...
    description: 'Registra un cliente en la base de datos. Requiere autenticación JWT.',
  })
  @ApiResponse({ status: 201, description: 'Cliente creado exitosamente.' })
  @ApiResponse({ status: 400, description: 'Datos inválidos o campos faltantes.' })
  @ApiResponse({ status: 401, description: 'No autenticado. Se requiere token JWT.' })
  @ApiResponse({ status: 409, description: 'Ya existe un cliente con ese correo o NIT.' })
